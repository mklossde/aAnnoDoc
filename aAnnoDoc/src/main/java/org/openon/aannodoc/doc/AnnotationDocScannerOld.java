...
public class AnnotationDocScannerOld {
...
//System.out.println("T:"+str.substring(pos,next));
				...
				AnnotationDocScannerOld obj=new AnnotationDocScannerOld(str,next);
//System.err.println("A:"+str.substring(next,obj.pos));
	...
	public static AnnotationDocScannerOld scan(String str) { return scan(str,0); }
	
	public static AnnotationDocScannerOld scan(String str,int pos) {
		int next=nextAnnotation(str, pos,true);
		if(next==-1) { return null; }
		else { return new AnnotationDocScannerOld(str,next); }
	}
	
	//------------------------------------------------------------
	
	public AnnotationDocScannerOld() {}
	
	public  AnnotationDocScannerOld(String str) { this(str,0); }
	public  AnnotationDocScannerOld(String str,int startPos) {
