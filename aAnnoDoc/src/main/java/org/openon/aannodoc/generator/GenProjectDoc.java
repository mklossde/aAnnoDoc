...
public class GenProjectDoc extends AsciiDocGeneratorImpl implements DocGenerator {
	private static final Logger LOG=LoggerFactory.getLogger(GenProjectDoc.class);
	
	public static final String NAME="ProjectDoc";
	
	public GenProjectDoc() {super();}
