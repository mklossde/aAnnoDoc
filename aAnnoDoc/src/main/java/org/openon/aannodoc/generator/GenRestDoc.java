...
public class GenRestDoc extends AsciiDocGeneratorImpl implements DocGenerator {
	private static final Logger LOG=LoggerFactory.getLogger(GenRestDoc.class);
	
	public static final String NAME="RestDoc";
	
	public GenRestDoc() {super();}
